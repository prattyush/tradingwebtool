...
const OrderInputTrade = ({tradingStyle, ipAddress, replaySpeed, ceStrikePrice, peStrikePrice, tradeDate}) => {
    ...
    return (
        <div style={{float:"left", marginTop:'1%', marginRight: '1%', marginLeft: '1%', width:"96%", border: '1px solid black' }}>
            ...
            <div style={{float:"left", marginTop:'1%', marginRight: '1%', border: '1px solid black'}}>
                <label style={{clear:"both", float:"left", marginTop:'1%', marginRight: '1%'}}>Choose Trade Management Command :: </label>
                <select  style={{clear:"both", float:"left", marginTop:'1%', border: '1px solid black'}} name="ManagementCmd" id="managementCmd" defaultValue={tdMngmtCmd} value={tdMngmtCmd} onChange={(e) => setTdMngmtCmd(e.target.value)}>
                    <option>L</option>
                    <option>LT</option>
                    <option>LTO</option>
                    <option>LN</option>
                ...
                <input style={{float:"left", marginLeft: '1%', marginTop:'1%'}} type="commandInput" value={cmdInputMngTd}  onChange={(e) => setCmdInputMngTd(e.target.value)}/>
                ...
                <button style={{clear:"both", float:"left", marginTop:'1%', border: '1px solid black'}} type="button" onClick={onTdManagementCommandPlaced} title="ManageTrade">ManageTrade</button>
            ...
            <div style={{float:"right", marginTop:'1%', marginRight: '1%', width:"45%", border: '1px solid black'}}>
...
export default OrderInputTrade;