...
const OrderInputTrade = ({tradingStyle, ipAddress, replaySpeed, ceStrikePrice, peStrikePrice, tradeDate}) => {
    ...
    return (
        <div style={{float:"left", marginTop:'1%', marginRight: '1%', marginLeft: '1%', width:"96%", height:"96%", border: '1px solid black' }}>
            ...
            <div style={{float:"right", marginTop:'1%', marginRight: '1%', width:"45%",  height:"75%", border: '1px solid black'}}>
                ...
                <textarea style={{float:"right", marginTop:'1%', marginRight: '1%', fontSize:'0.6rem', width:"57%", height:"75%"}} name="tradeInfo" rows={6} cols={40} value={tradeInfo} readOnly={true}>info</textarea>
            </div>
        </div>
    );
};
